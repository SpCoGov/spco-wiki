...
public class LogUtil {
    ...
    /**
     * 检查当前 {@code Logger} 的活跃状态。如果 {@code Logger} 的上下文是一个生命周期( {@code LifeCycle} )实例，并且该实例已经停止，
     * 那么返回false。否则，返回true。
     *
     * @return {@code Logger} 的活跃状态。如果 {@code Logger} 已经停止，则返回 {@code false} ，否则返回 {@code true} 。
     */
